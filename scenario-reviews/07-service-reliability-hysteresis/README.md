...
Review **Scenario 7: Service Reliability Hysteresis and Price vs. ETA Trade-offs (Intermediate)**, described in [DESCRIPTION.md](DESCRIPTION.md), against the existing implementation of this simulator. The repository root is two directories above this folder.
