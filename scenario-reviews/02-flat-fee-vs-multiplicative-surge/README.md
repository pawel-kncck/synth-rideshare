...
Review **Scenario 2: Flat-Fee Bonus vs. Multiplicative Surge Under Distance Heterogeneity (Straightforward)**, described in [DESCRIPTION.md](DESCRIPTION.md), against the existing implementation of this simulator. The repository root is two directories above this folder.
