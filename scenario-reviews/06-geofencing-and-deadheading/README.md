...
Review **Scenario 6: Asymmetric Geo-Fencing, Deadheading, and Suburban Supply Deserts (Intermediate)**, described in [DESCRIPTION.md](DESCRIPTION.md), against the existing implementation of this simulator. The repository root is two directories above this folder.
