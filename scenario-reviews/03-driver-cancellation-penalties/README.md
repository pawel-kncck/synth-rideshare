...
Review **Scenario 3: Driver Cancellation Penalties and Completion Reliability (Straightforward)**, described in [DESCRIPTION.md](DESCRIPTION.md), against the existing implementation of this simulator. The repository root is two directories above this folder.
