...
Review **Scenario 8: Mid-Trip Regulatory Price Cap and Contract Immutability (Difficult)**, described in [DESCRIPTION.md](DESCRIPTION.md), against the existing implementation of this simulator. The repository root is two directories above this folder.
